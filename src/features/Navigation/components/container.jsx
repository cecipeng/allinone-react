...
//                                     <a className='btn-view btn-view-detail on' title='详细'></a>  
//                                     <a className='btn-view btn-view-list' title='缩略'></a>
//                                     <a className='btn-view btn-view-slider' title='收起'></a>
//                                 </p>
...
//                         <div className='navigation-box navigation-mod-list' v-for='item in memberList' v-else>
